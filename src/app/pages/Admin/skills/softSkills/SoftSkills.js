...
const SoftSkills = () => {
    ...
    const navigationAction = () => navigation("/admin/skills/soft/create")
    const editAction = (option, state) => navigation(`/admin/skills/soft/edit`, { state })
        ...
        <JumboCardQuick
            ...
            action={
                <Button
                    ...
                    variant="contained"
                    startIcon={<FontAwesomeIcon icon={faUncharted} />}>
                    Add
                </Button>
            }
            headerSx={{
