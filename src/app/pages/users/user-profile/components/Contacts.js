            ...
            <List disablePadding sx={{ mb: 2 }}>
                <ListItem alignItems="flex-start" sx={{ p: theme => theme.spacing(.5, 3) }}>
                    ...
                    <ListItemText
                        ...
                        secondary={<Link variant="body1" href="#" underline="none">mahesh.chudasama098@gmail.com</Link>}
                    />
                </ListItem>
                <ListItem alignItems="flex-start" sx={{ p: theme => theme.spacing(.5, 3) }}>
                    <ListItemIcon sx={{ minWidth: 36, color: 'text.secondary' }}>
                    ...
                    <ListItemText
                        ...
                        secondary={<Link variant="body1" href="#" underline="none">maheshChudasam.com</Link>}
                    />
                </ListItem>
                <ListItem alignItems="flex-start" sx={{ p: theme => theme.spacing(.5, 3) }}>
                    <ListItemIcon sx={{ minWidth: 36, color: 'text.secondary' }}>
                    ...
                    <ListItemText
                        ...
                        secondary={<Typography variant="body1" color="text.primary">+91 7202841815</Typography>}
                    />
                </ListItem>
            </List>
        </JumboCardQuick>
